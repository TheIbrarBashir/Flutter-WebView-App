...
class _WebViewPageState extends State<WebViewPage> {
  ...
  void downloadFile({required String url}) async {
    final taskId = await FlutterDownloader.enqueue(
      ...
      fileName:
          'prasoInvoice_${DateTime.now().toString().replaceAll(' ', '').replaceAll(':', '').replaceAll('-', '').replaceAll('.', '')}.pdf',
      url: url,
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          body: Stack(children: [
            ...
            WebView(
              ...
              navigationDelegate: (navigation) async {
                String checkPdf = navigation.url.substring(
                    navigation.url.length - 3, navigation.url.length);
                var permission = await Permission.storage.request();

                if (navigation.url.contains('https://api.pagar.me') &&
                    checkPdf.contains('pdf')) {
            ...
            Selector<PrasoNotifyProvider, String>(
              ...
              builder: (context, value, child) => Visibility(
                visible:
                    prasoNotifyProvider!._url.contains('https://praso.com.br/'),
                child: Positioned(
                  right: 0,
                  bottom: 0,
                  left: 0,
          ...
          bottomNavigationBar: Selector<PrasoNotifyProvider, String>(
            ...
            builder: (context, value, child) => Visibility(
              visible: !(prasoNotifyProvider!._url
                  .contains('https://praso.com.br/')),
              child: Card(
                elevation: 20,
                child: Container(
                  height: 90,
                      ...
                      GestureDetector(
                          ...
                          child: Selector<PrasoNotifyProvider, Color>(
                              ...
                              builder: (context, value, child) =>
                                  bottomNavigationBarItems(
                                      imagePath:
                                          prasoNotifyProvider!.url.length ==
                                                  'https://praso.com.br/'.length
                                              ? 'assets/images/home_select.png'
                                              : 'assets/images/home_icon.png',
                                      iconText: 'início',
